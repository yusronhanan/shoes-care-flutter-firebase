...
class AllCompleteOrderPage extends StatefulWidget {

  @override
  _AllCompleteOrderState createState() => _AllCompleteOrderState();
}

class _AllCompleteOrderState extends State<AllCompleteOrderPage> {
  String currentStatus = "Complete";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        children: <Widget>[
          Text("Complete Order Data", style: TextStyle(fontSize: 20)),
          Padding(
            padding:
