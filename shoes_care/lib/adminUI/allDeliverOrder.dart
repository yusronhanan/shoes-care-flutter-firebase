...
class AllDeliverOrderPage extends StatefulWidget {
  ...
  @override
  _AllDeliverOrderState createState() => _AllDeliverOrderState();
}

class _AllDeliverOrderState extends State<AllDeliverOrderPage> {
  String currentStatus = "Deliver";
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Text("Deliver Order Data", style: TextStyle(fontSize: 20)),
          Padding(
            padding:
