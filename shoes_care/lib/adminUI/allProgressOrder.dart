...
class AllProgressOrderPage extends StatefulWidget {

  @override
  _AllProgressOrderState createState() => _AllProgressOrderState();
}

class _AllProgressOrderState extends State<AllProgressOrderPage> {
  String currentStatus = "Progress";
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Text("Progress Order Data", style: TextStyle(fontSize: 20)),
          Padding(
            padding:
